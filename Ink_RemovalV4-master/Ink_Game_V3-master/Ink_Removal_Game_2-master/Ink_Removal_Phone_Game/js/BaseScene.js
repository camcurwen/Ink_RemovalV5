class BaseScene extends Phaser.Scene{
	...
	create(){
       ...
       // if (clickableTile === null){  if (clcickableTile.properties !== clciked  } if(tile.alreadyClickable)  {  null tile.setVisable(true);    //if all clcickable tiles are clicked go to next scene. 
	}
